 ...
 */
public class AsthmaLungsDiseasesIndices extends Thread {
    ...
    String getInfo = "http://203.247.66.146/iros/RetrieveWhoIndexService/getAsthmaWhoList?";
    int Frag = 0;

    public AsthmaLungsDiseasesIndices(boolean receiver, int Frag) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(tResponse) {
                    ...
                    data = 0;
                    if(Frag == 1) {
                        HealthFragment.AsthmaLungsDiseasesThreadResponse(sCode, sAreaNo, sDate, sToday, sTomorrow, stheDayAfterTomorrow);
                    }
                }
            }
        });
