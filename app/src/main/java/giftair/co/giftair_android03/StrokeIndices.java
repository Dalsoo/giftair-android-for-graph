 ...
 */
public class StrokeIndices extends Thread {
    ...
    String getInfo = "http://203.247.66.146/iros/RetrieveWhoIndexService/getBrainWhoList?";
    int Frag = 0;

    public StrokeIndices(boolean receiver, int Frag) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(tResponse) {
                    ...
                    data = 0;
                    if(Frag == 1) {
                        HealthFragment.StrokeThreadResponse(sCode, sAreaNo, sDate, sToday, sTomorrow, stheDayAfterTomorrow);
                    }
                }
            }
        });
