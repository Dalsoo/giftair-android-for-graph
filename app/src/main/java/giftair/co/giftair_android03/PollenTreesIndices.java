 ...
 */
public class PollenTreesIndices extends Thread {
    ...
    String getInfo = "http://203.247.66.146/iros/RetrieveWhoIndexService/getFlowerWoodyWhoList?";
    int Frag = 0;

    public PollenTreesIndices(boolean receiver, int Frag) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(tResponse) {
                    ...
                    data = 0;
                    if(Frag == 1) {
                        HealthFragment.PollenTreesThreadResponse(sCode, sAreaNo, sDate, sToday, sTomorrow, stheDayAfterTomorrow);
                    }
                }
            }
        });
