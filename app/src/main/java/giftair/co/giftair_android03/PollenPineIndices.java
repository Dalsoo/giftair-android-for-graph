 ...
 */
public class PollenPineIndices extends Thread {
    ...
    String getInfo = "http://203.247.66.146/iros/RetrieveWhoIndexService/getFlowerPineWhoList?";
    int Frag = 0;

    public PollenPineIndices(boolean receiver, int Frag) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(tResponse) {
                    ...
                    data = 0;
                    if(Frag == 1) {
                        HealthFragment.PollenPineThreadResponse(sCode, sAreaNo, sDate, sToday, sTomorrow, stheDayAfterTomorrow);
                    }
                }
            }
        });
