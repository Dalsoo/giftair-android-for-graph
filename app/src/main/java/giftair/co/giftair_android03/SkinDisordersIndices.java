 ...
 */
public class SkinDisordersIndices extends Thread {
    ...
    String getInfo = "http://203.247.66.146/iros/RetrieveWhoIndexService/getSkinWhoList?";
    int Frag = 0;

    public SkinDisordersIndices(boolean receiver, int Frag) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(tResponse) {
                    ...
                    data = 0;
                    if(Frag == 1) {
                        HealthFragment.SkinDisordersThreadResponse(sCode, sAreaNo, sDate, sToday, sTomorrow, stheDayAfterTomorrow);
                    }
                }
            }
        });
